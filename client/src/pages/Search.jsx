  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <div className='w-full'>
            <h1 className='text-2xl font-medium p-3 mt-5 italic'>Results:</h1>
            <div className='p-7 flex flex-wrap gap-4'>
                {!loading && posts.length === 0 && (
                    <p className='text-l text-gray-500'>No posts yet!!.</p>
                )}
                {loading && <p className='text-l text-gray-500'>Loading..</p>}
                {!loading &&
                    posts &&
                ...
                {showMore && (
                    ...
                    className='text-blue-400 text-lg hover:underline p-7 w-full'
                    >
                    Show More
                    </button>
                )}
