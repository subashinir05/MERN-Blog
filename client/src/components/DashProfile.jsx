...
export default function DashProfile() {
  ...
  const [imageFileUploadError, setImageFileUploadErorr] = useState(null)
  ...
  if(imageFile){
    ...
    const handleSubmit = async (e) => {
      ...
      if(imageFileUploading){
        setUpdateUserError('Image not yet uploaded, Wait!!')
        return;
      }
      try {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
        ...
        className={`rounded-full w-full h-full object-cover border-2 border-[rgb(205,205,236)]
      ...
      <Modal
        show={showModal} onClose={() => setShowmodal(false)} popup size='md'>
          <Modal.Header />
          <Modal.Body>
