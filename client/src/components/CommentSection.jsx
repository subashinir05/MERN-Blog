    ...
    {currentUser && (
        ...
        className='border border-teal-400 rounded-md p-3'>
            ...
            <div className=' flex justify-between items-center mt-5'>
                <p className='text-gray-400 text-xs'>{100 - comment.length} Characters remaining</p>
                <Button className='bg-gradient-to-r from-blue-300 to-teal-300' outline type='submit'>
                    Submit
                </Button>
            </div>
            {commentError && (
